...
(function (w) {
    ...
    p.createViewer = function () {
        ...
        this.renderer.view.setAttribute("id", "htmlglContainer"); // added by Robin
    ...
    p.initElements = function () {
        console.trace("context : initElements ", w.HTMLGL.elements);
        w.HTMLGL.elements.forEach(function (element) {
            element.init();
        });
    }
    ...
    p.updateElementsPositions = function () {
        console.trace("context : updateElementsPositions ", w.HTMLGL.elements);
        w.HTMLGL.elements.forEach(function (element) {
